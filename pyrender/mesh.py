...
class Mesh(object):
    ...
    @staticmethod
    def from_trimesh(
        mesh, material=None, is_visible=True, poses=None, wireframe=False, smooth=True
    ):
        ...
        for m in meshes:
            ...
            color_0, texcoord_0, primitive_material = Mesh._get_trimesh_props(
                m, smooth=smooth, material=material
            )
